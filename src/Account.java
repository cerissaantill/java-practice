...
public class Account {
    ...
    // creating Fields (field/values) for requested variables:
    ...
    // this default Constructor below is just to test:
    // the point of a constructor is to initialize the object you're created.
